...
static M5Canvas sprite(&display);
...
void test(M5GFX &lcd)
{
  ...
  lcd.drawBmp((const uint8_t*)nullptr, 0, 0, 0);
  lcd.drawPng((const uint8_t*)nullptr, 0, 0, 0);
  lcd.drawJpg((const uint8_t*)nullptr, 0, 0, 0);
  lcd.drawQoi((const uint8_t*)nullptr, 0, 0, 0);

  lcd.pushState();
  lcd.popState();

  lcd.progressBar(0, 0, 100, 20, 50);
}
