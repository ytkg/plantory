...
重量をグラムで1秒ごとに大きく表示します。ゼロ付近（±1.0g）は`0.0g`として扱います。日本時間の0時・3時・6時・9時・12時・15時・18時・21時に自動送信し、起動直後に自動送信することはありません。ダブルタップで、100ms間隔で10回測定した平均を`weight`として即時送信します。2秒長押しでは最大5回のWi-Fi再接続を開始できます。
